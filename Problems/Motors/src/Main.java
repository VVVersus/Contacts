...
class PneumaticMotor extends Motor {
    public PneumaticMotor(String motor, long power) {
        super(motor, power);
    }
    @Override
    public String toString() {
...
class HydraulicMotor extends Motor {
    public HydraulicMotor(String motor, long power) {
        super(motor, power);
    }
    @Override
    public String toString() {
...
class ElectricMotor extends Motor {
    public ElectricMotor(String motor, long power) {
        super(motor, power);
    }
    @Override
    public String toString() {
...
class WarpDrive extends Motor {
    public WarpDrive(String motor, long power) {
        super(motor, power);
    }
    @Override
    public String toString() {
